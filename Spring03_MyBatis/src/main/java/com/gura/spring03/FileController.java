...
public class FileController {
	 ...
	 *  3. <input type="file" nane="myFile" /> 에서 name 속성의 value 를
	 *  	MultipartFile type 을 받을 때 지역 변수명 혹은 필드명과 일치 시킨다.
	...
	public ModelAndView upload(ModelAndView mView,
		...
		try {
			//파일을 저장할 전체 경로를 구성한다.		.../webapp/upload/1212123413323xxx.jpg
