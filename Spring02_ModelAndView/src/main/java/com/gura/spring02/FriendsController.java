...
/* 
 * 어노테이션을 붙이면?
 *  component scan 을 통해서 객체가 생성이 되고 spring bean container 에서 관리가 된다.
 */
@Controller
public class FriendsController {
	...
	// spring 이 알아서 객체를 생성해서 참조값을 메소드의 인자로 전달해준다.
	...
	public ModelAndView delete2(ModelAndView mView) {
		...
		// ModelAndView 객체를 이용해서 redirect 이동을 할 수도 있다.
